...
$x_n \to x$. Then,
\eQb
\sum_k |(x)_k - (x_n)_k| \to 0 \>\> \text{as} \>\> n \to \infty,
\eQe
which implies
\eQb
(x_n)_k \to (x)_k \>\> \text{ as} \>\> n \to \infty
\eQe
...
\eQb
\sum_k |(y)_k - (y_n)_k| \to 0 \>\> \text{as} \>\> n \to \infty,
\eQe
which implies 
\eQb
(y_n)_k \to (y)_k \>\> \text{ as} \>\> n \to \infty
\eQe
...
\eQb
\lim_{n} (y_n)_{2k} &=& \lim_{n} \dfrac{1}{2^k} (y_n)_{2k-1} = 
\dfrac{1}{2^k} \lim_{n} (y_n)_{2k-1} = \dfrac{1}{2^k}(y)_{2k-1},
\eQe
...
\eQb
\dfrac{1}{2^n} &=& \dfrac{1}{2^n}y_{2n-1},
\eQe
which implies 
\eQb
y_{2n-1} &=& 1,
